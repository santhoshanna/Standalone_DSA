...
public class TiltOfABinaryTree {
    ...
    public static int tilt(Node node) {
        ...
        int nodeTilt = Math.abs(sum(node.left) - sum(node.right));
        return leftTilt + rightTilt + nodeTilt;
    }
    ...
    public static int tilt1(Node node) {
        ...
        int sum = 0;
        int sumLeft = tilt1(node.left);
        int sumRight = tilt1(node.right);
        sum = sumLeft + sumRight + node.data;
